...
function smoothCircle480_then_cameraAim(targetModel)
    ...
    local degreesPercent = currentSliderValues["Dash Degrees"] or (savedSettings and savedSettings.Sliders and tonumber(savedSettings.Sliders["Dash Degrees"]) or math.floor((407 - 90) / (1080 - 90) * 100))
