...
--  * Refresh button properly refreshes the player list (also PlayerAdded/Removed update list automatically)
--  * Slider knob (circle) made bigger
--  * Each slider now has a numeric indicator (shows mapped value)
--  * Dash UI width increased to fit indicators
--  * Slider mappings made more significant; Dash speed can now exceed previous "max" (faster spins)
