--// Kiba v4 Tech (modified UI) - Updated
-- Added: Keyboard toggle (K) and trigger SFX
-- Cooldown changed from 7.2 to 4.2
...
local COOLDOWN_DURATION = 4.2 -- changed from 7.2 to 4.2
...
UserInputService.InputBegan:Connect(function(input, gpe)
    ...
    if input.KeyCode == Enum.KeyCode.K then
        ...
        if enabled then
            ...
            Button.Text = "Kiba v4 Tech:Off"
            Button.BackgroundColor3 = Color3.fromRGB(40,40,40)
            -- clean up character connections immediately when disabled
...
-- Simple SFX (plays when tryTrigger runs)
local TriggerSound = Instance.new("Sound")
TriggerSound.Name = "KibaTriggerSFX"
TriggerSound.Volume = 0.7
TriggerSound.Looped = false
TriggerSound.SoundId = "rbxassetid://183763515" -- example sound; change if you have another asset id
