...
local function createExtraFrame()
    ...
    extraFrame.Size = UDim2.new(0, 220, 0, 110)
    -- default position near center of screen; draggable
    extraFrame.Position = UDim2.new(0.5, -110, 0.5, -55)
    ...
    studsLabel.Size = UDim2.new(0, 60, 0, 28)
    studsLabel.Position = UDim2.new(0, 8, 0, 36)
    ...
    studsValue.Size = UDim2.new(0, 48, 0, 28)
    studsValue.Position = UDim2.new(0, 76, 0, 36)
    studsValue.BackgroundTransparency = 1
    studsValue.Text = tostring(ARC_APPROACH_RADIUS)
    studsValue.Font = Enum.Font.Gotham
    studsValue.TextSize = 14
    ...
    speedValue.Size = UDim2.new(0, 48, 0, 28)
    speedValue.Position = UDim2.new(0, 76, 0, 72)
    speedValue.BackgroundTransparency = 1
    speedValue.Text = string.format("%.2f", SPEED_SETTING)
    ...
    speedMinus.Position = UDim2.new(0, 130, 0, 72)
    ...
    speedPlus.Position = UDim2.new(0, 166, 0, 72)
    ...
    speedMinus.MouseButton1Click:Connect(function()
        -- decrease SPEED_SETTING by 0.25, clamp to 0.25 minimum
        SPEED_SETTING = math.max(0.25, math.floor((SPEED_SETTING - 0.25) * 100 + 0.5) / 100)
        if SPEED_SETTING < 0.25 then SPEED_SETTING = 0.25 end
        speedValue.Text = string.format("%.2f", SPEED_SETTING)
    end)

    speedPlus.MouseButton1Click:Connect(function()
        -- increase SPEED_SETTING by 0.25, clamp to 3.0 maximum
        SPEED_SETTING = math.min(3.0, math.floor((SPEED_SETTING + 0.25) * 100 + 0.5) / 100)
        speedValue.Text = string.format("%.2f", SPEED_SETTING)
    end)
