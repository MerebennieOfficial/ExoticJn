...
-- === Enforced runtime defaults (applied to script behavior, not only UI) ===
-- These values were requested and will override or initialize the runtime variables
-- so the script actually uses these settings during execution.
local DEFAULT_DASH_SPEED = 0.82
local DEFAULT_DASH_DEGREES = 406
local DEFAULT_DASH_GAP = 2.4

-- Apply to common variable names (create or override)
DashSpeed = DEFAULT_DASH_SPEED
dashSpeed = DEFAULT_DASH_SPEED
dash_time = DEFAULT_DASH_SPEED

DashDegrees = DEFAULT_DASH_DEGREES
dashDegrees = DEFAULT_DASH_DEGREES

DashGap = DEFAULT_DASH_GAP
dash_gap = DEFAULT_DASH_GAP
-- === end enforced defaults ===
