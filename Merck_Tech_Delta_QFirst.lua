...
-- === Main stick dash (modified order: Q first, then delay, then lay down) ===
local function stickDash()
    ...
    -- Step 1: fire Q immediately
    pcall(fireQ)

    -- Step 2: after 0.3s, lay down
    ...
    -- stop immobilizing after total time
...
-- === Minimal Info Box (tiny: title + close only) ===
local InfoFrame = Instance.new("Frame")
InfoFrame.Name = "MerebennieInfoBox"
InfoFrame.Size = UDim2.new(0, 180, 0, 40) -- smaller box
...
-- Make InfoFrame draggable for PC & mobile
do
    local dragging, dragInput, dragStart, startPos
