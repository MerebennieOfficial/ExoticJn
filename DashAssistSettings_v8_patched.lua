...
local function safeSetParent(gui)
    local success = false
    pcall(function() safeSetParent(gui) success = (gui.Parent ~= nil) end)
    ...
    -- final fallback
    pcall(function() safeSetParent(gui) end)
end
...
local function createSettingsUI()
    ...
    mainFrame.Size = UDim2.new(0,300,0,320) -- increased height to fit rearranged controls
    ...
    findNearestBtn.Position = UDim2.new(0,12,0,172)
    findNearestBtn.Text = "Find nearest: ON"
    findNearestBtn.Font = Enum.Font.Gotham
    ...
    m1Btn.Position = UDim2.new(0.52,2,0,172)
    m1Btn.Text = "M1: On"
    m1Btn.Font = Enum.Font.Gotham
    m1Btn.TextSize = 14
    ...
    espBtn.Position = UDim2.new(0.52,2,0,212) -- below M1 button
    espBtn.Text = "Esp: Off"
    ...
    delayLabel.Position = UDim2.new(0,12,0,256)
    ...
    delayBox.Position = UDim2.new(0.5, 2, 0, 252)
