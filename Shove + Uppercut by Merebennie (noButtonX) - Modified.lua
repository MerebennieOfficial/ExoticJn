    ...
    for i, name in ipairs(TitleLabels) do
        ...
        if currentSliderValues[name] ~= nil then
            ...
            elseif name == "Dash Degrees" then
                -- default to ~406 degrees (user requested)
                initValue = math.floor((406 - 90) / (1080 - 90) * 100)
...
function smoothCircle480_then_cameraAim(targetModel)
    ...
    local speedPercent = currentSliderValues["Dash speed"] or (savedSettings and savedSettings.Sliders and tonumber(savedSettings.Sliders["Dash speed"]) or 49)
    local degreesPercent = currentSliderValues["Dash Degrees"] or (savedSettings and savedSettings.Sliders and tonumber(savedSettings.Sliders["Dash Degrees"]) or math.floor((406 - 90) / (1080 - 90) * 100))
    local gapPercent = currentSliderValues["Dash gap"] or (savedSettings and savedSettings.Sliders and tonumber(savedSettings.Sliders["Dash gap"]) or 14)
